...
## SE
plot_SE_1<-
  result_sim_all %>% filter(scenario==1) %>% ggplot(aes(x=theta_cnt, y=SE,
                                                        color=factor(method, levels=label_method),
                                                        linetype=factor(method, levels=label_method))) +
  geom_point(size=size_point) + geom_line() +
  scale_y_continuous(limits=c(0.1,0.2), breaks=seq(0.1, 0.2, 0.02)) +
  xlim(c(min(theta_cnt), max(theta_cnt))) +
  ggtitle(expression("(" * theta^(1) * "," ~ theta^(2) * ") = (0, 0)" )) +
  xlab(expression(theta^(0))) +
  theme(plot.title=element_text(hjust=0.5, size=15),
...
plot_SE_2<-
  result_sim_all %>% filter(scenario==2) %>% ggplot(aes(x=theta_cnt, y=SE,
                                                        color=factor(method, levels=label_method),
                                                        linetype=factor(method, levels=label_method))) +
  geom_point(size=size_point) + geom_line() +
  scale_y_continuous(limits=c(0.1,0.2), breaks=seq(0.1, 0.2, 0.02)) +
...
plot_SE_3<-
  result_sim_all %>% filter(scenario==3) %>% ggplot(aes(x=theta_cnt, y=SE,
                                                        color=factor(method, levels=label_method),
                                                        linetype=factor(method, levels=label_method))) +
  geom_point(size=size_point) + geom_line() +
  scale_y_continuous(limits=c(0.1,0.2), breaks=seq(0.1, 0.2, 0.02)) +
...
plot_SE_4<-
  result_sim_all %>% filter(scenario==4) %>% ggplot(aes(x=theta_cnt, y=SE,
                                                        color=factor(method, levels=label_method),
                                                        linetype=factor(method, levels=label_method))) +
  geom_point(size=size_point) + geom_line() +
  scale_y_continuous(limits=c(0.1,0.2), breaks=seq(0.1, 0.2, 0.02)) +
...
plot_SE_5<-
  result_sim_all %>% filter(scenario==5) %>% ggplot(aes(x=theta_cnt, y=SE,
                                                        color=factor(method, levels=label_method),
                                                        linetype=factor(method, levels=label_method))) +
  geom_point(size=size_point) + geom_line() +
  scale_y_continuous(limits=c(0.1,0.2), breaks=seq(0.1, 0.2, 0.02)) +
...
plot_SE_6<-
  result_sim_all %>% filter(scenario==6) %>% ggplot(aes(x=theta_cnt, y=SE,
                                                        color=factor(method, levels=label_method),
                                                        linetype=factor(method, levels=label_method))) +
  geom_point(size=size_point) + geom_line() +
  scale_y_continuous(limits=c(0.1,0.2), breaks=seq(0.1, 0.2, 0.02)) +
...
plot_SE_all<-ggarrange(plot_SE_1, plot_SE_4, 
                       plot_SE_2, plot_SE_5,
                       plot_SE_3, plot_SE_6,
                       labels=c("#1", "#4",
                                "#2", "#5",
